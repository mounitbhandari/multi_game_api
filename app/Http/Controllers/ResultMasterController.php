...
//                ->get();
    ...
    public function get_result_today_last_by_game($id){
        ...
        $return_array = [];
        $draw_id = [];
        $resultMasters = ResultMaster::whereGameId($id)->whereGameDate($today)->orderBy('id','DESC')->orderBy('draw_master_id','DESC')->limit(7)->get();
...
//            }
        ...
        $return_array = (array((collect($return_array)->sortBy('draw_time')->reverse()->toArray())));
