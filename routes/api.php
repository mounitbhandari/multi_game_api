...
//    Route::get("logout/{id}",[UserController::class,'logout']);
    ...
    //single_numbers
    Route::get("singleNumbers",[SingleNumberController::class,'index'])->middleware('cache.headers:private;max_age=86300');

    //number_combinations
    Route::get("numberCombinations",[NumberCombinationController::class,'index'])->middleware('cache.headers:private;max_age=86300');
    Route::get("numberCombinations/number/{id}",[NumberCombinationController::class,'getNumbersBySingleNumber']);
    Route::get("numberCombinations/matrix",[NumberCombinationController::class,'getAllInMatrix'])->middleware('cache.headers:private;max_age=86300');
    ...
    //game_types
    Route::get('gameTypes',[GameTypeController::class,'index'])->middleware('cache.headers:private;max_age=86300');
...
//    Route::get('terminalLoggedId',[TerminalController::class, 'get_terminal_by_auth']);
    ...
    Route::get('getGame', [GameController::class, 'getGame'])->middleware('cache.headers:private;max_age=86300');
    Route::get('gameTotalReportToday', [GameController::class, 'get_game_total_sale_today']);
    Route::get('getSingleNumber', [SingleNumberController::class, 'get_all_single_number'])->middleware('cache.headers:private;max_age=86300');
...
//    PAYOUT SLABS
    ...
    Route::get('getDoubleNumber', [DoubleNumberCombinationController::class, 'get_all_double_number'])->middleware('cache.headers:private;max_age=86300');

    Route::post('pinCheckValidation',[UserController::class, 'check_pin']);

    Route::get('getTwelveCards',[CardCombinationController::class, 'get_all_twelve_card'])->middleware('cache.headers:private;max_age=86300');
    Route::get('getSixteenCards',[CardCombinationController::class, 'get_all_sixteen_card'])->middleware('cache.headers:private;max_age=86300');
    ...
    Route::get('getAndarNumbers',[AndarNumberController::class, 'get_all_andar_number'])->middleware('cache.headers:private;max_age=86300');
    Route::get('getBaharNumbers',[BaharNumberController::class, 'get_all_bahar_number'])->middleware('cache.headers:private;max_age=86300');
